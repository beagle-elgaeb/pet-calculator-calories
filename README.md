...
- добавить нечто, что даст понять, что данные сохранены - после сохранения профиля;
- отображать инфографику только в текущем дне или продумать как в день сохранять ещё и информацию о том, какая была норма на этот день;
